...
expect(page.current_url).to eq("http://test.example.com/platform/")
 end

scenario "Ensure subdomain uniqueness" do
Platform::Account.create!(:subdomain => "test", :name => "Test")
visit platform.root_path
click_link "Account Sign Up"
fill_in "Name", :with => "Test"
fill_in "Subdomain", :with => "test"
...
fill_in "Password confirmation", :with => 'password'
click_button "Create Account"
expect(page.current_url).to eq("http://www.example.com/platform/accounts")
